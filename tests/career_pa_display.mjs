...
try{
  ...
  const result=await page.evaluate(async()=>{
    ...
    const career=await import('./src/engine/career.js?v=1.5.10');
    const retire=await import('./src/ui/retire.js?v=1.5.10');
    const share=await import('./src/ui/share-image.js?v=1.5.10');
