...
try{
  ...
  const report=await page.evaluate(async samplesPerBand=>{
    const state=await import('./src/core/state.js?v=1.5.10');
    const season=await import('./src/engine/season.js?v=1.5.10');
    const contract=await import('./src/engine/contract.js?v=1.5.10');
    const {LV}=await import('./src/data/teams.js?v=1.5.10');
