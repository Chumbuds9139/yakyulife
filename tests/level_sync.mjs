...
try{
  ...
  const result=await page.evaluate(async()=>{
    ...
    const timeline=await import('./src/ui/timeline.js?v=1.6.5');
    const phases=await import('./src/flow/phases.js?v=1.6.5');
    const contract=await import('./src/engine/contract.js?v=1.6.5');
    const ability=await import('./src/engine/ability.js?v=1.6.5');
    const events=await import('./src/flow/events.js?v=1.6.5');
    const data=await import('./src/data/events.js?v=1.6.5');
    const {board}=await import('./src/ui/dom.js?v=1.6.5');
