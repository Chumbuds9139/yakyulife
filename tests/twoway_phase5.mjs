...
try{
  ...
  const r=await page.evaluate(async()=>{
    ...
    const career=await import('./src/engine/career.js?v=1.6.3');
    const retire=await import('./src/ui/retire.js?v=1.6.3');
    const share=await import('./src/ui/share-image.js?v=1.6.3');
    ...
    const dom=await import('./src/ui/dom.js?v=1.6.3');
    dom.board(1);
