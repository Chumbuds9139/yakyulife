...
try{
  ...
  const result=await page.evaluate(async()=>{
    ...
    const career=await import('./src/engine/career.js?v=1.6.2');
    const retire=await import('./src/ui/retire.js?v=1.6.2');
    const teams=await import('./src/data/teams.js?v=1.6.2');
    const share=await import('./src/ui/share-image.js?v=1.6.2');
