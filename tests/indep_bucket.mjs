...
try{
  ...
  const result=await page.evaluate(async()=>{
    ...
    const season=await import('./src/engine/season.js?v=1.5.29');
    const career=await import('./src/engine/career.js?v=1.5.29');
    const retire=await import('./src/ui/retire.js?v=1.5.29');
    const teams=await import('./src/data/teams.js?v=1.5.29');
    const share=await import('./src/ui/share-image.js?v=1.5.29');
