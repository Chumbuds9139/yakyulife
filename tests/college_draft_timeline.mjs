...
try{
  ...
  const result=await page.evaluate(async()=>{
    const state=await import('./src/core/state.js?v=1.5.28');
    const timeline=await import('./src/ui/timeline.js?v=1.5.28');
    const phases=await import('./src/flow/phases.js?v=1.5.28');
