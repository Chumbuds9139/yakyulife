...
try{
  ...
  const result=await page.evaluate(async()=>{
    const state=await import('./src/core/state.js?v=1.5.16');
    const timeline=await import('./src/ui/timeline.js?v=1.5.16');
    const phases=await import('./src/flow/phases.js?v=1.5.16');
