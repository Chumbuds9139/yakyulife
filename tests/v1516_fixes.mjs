...
try{
  ...
  const result=await page2.evaluate(async()=>{
    ...
    const teams=await import('./src/data/teams.js?v=1.5.16');
    const events=await import('./src/flow/events.js?v=1.5.16');
    const data=await import('./src/data/events.js?v=1.5.16');
    const contract=await import('./src/engine/contract.js?v=1.5.16');
    const draft=await import('./src/engine/draft.js?v=1.5.16');
    const abilities=await import('./src/data/abilities.js?v=1.5.16');
