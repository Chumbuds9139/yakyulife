...
try{
  ...
  const result=await page2.evaluate(async()=>{
    ...
    const teams=await import('./src/data/teams.js?v=1.6.2');
    ...
    const draft=await import('./src/engine/draft.js?v=1.6.2');
    const abilities=await import('./src/data/abilities.js?v=1.6.2');
