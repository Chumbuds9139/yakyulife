...
try{
  ...
  const r=await page.evaluate(async()=>{
    ...
    const season=await import('./src/engine/season.js?v=1.6.5');
    const injury=await import('./src/engine/injury.js?v=1.6.5');
    const phases=await import('./src/flow/phases.js?v=1.6.5');
