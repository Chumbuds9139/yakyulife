...
export function newState(name,jersey,pos,role){
  ...
  return bindLevelOrg({name,jersey,pos,role:pos==='P'?null:null,perfectLock:false,invincible:false,age:16,year:2026,stage:'HS',stageYr:1,pot,
    ...
    ab,traits:{genius:false,glass:false,iron:false,scum:false,
      ...
      yips:false,distract:false,cancer:false,ambience:false,goldcloth:false,thief:false,latepractice:false,mrteam:false,confidante:false,smallschool:false,grinder:false,rainbow:false,samurai:false},
    ...
    stats:{CORP:null,INDEP:null,CPBL:null,NPB:null,MLB:null,MINOR:null},contracts:[],honors:[],legendLeagues:[],rainbowLeagues:[],pitcherTCLeagues:[],hitterTCLeagues:[],intlCount:0,intlLock:null,intlName:null});
}
...
export function stageLabel(){
  ...
  if(S.stage==='PRO'){
    ...
    const l=LV[S.lv]; if(l)return l.n;
  }
  return '進行中';
}
