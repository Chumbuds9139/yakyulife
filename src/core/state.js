import {R, ri} from './rng.js?v=1.6.2';
import {POS_AB} from '../data/abilities.js?v=1.6.2';
...
export function newState(name,jersey,pos,role){
 ...
 return bindLevelOrg({name,jersey,pos,role:null,perfectLock:false,invincible:false,
