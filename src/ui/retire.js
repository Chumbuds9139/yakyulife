...
import {shareImageSheet} from './share-image.js?v=1.5.8';
/* ================= 結算圖資料建構 =================
...
export function nextGameEnding(pos){
  ...
  return {title:'下一場比賽',body:`沒有鎂光燈，沒有滿場的觀眾。你揹著有點髒的球具袋，走進了休息室。<br><br>休息室裡有的孩子，才剛從大學畢業，眼裡依舊閃耀著對職業的嚮往。<br><br>你想起他們看見你的時候，眼神滿是詫異，然後有人小聲地說出你的名字——那個曾經出現在球員卡上、出現在賽後新聞裡的名字。<br><br>那天，休息室變成了一個小小的簽名會。<br><br>球衣是獨立聯盟的，胸前印著的贊助商是巷口的機車行。號碼隨便發的，不是你打了十幾二十年的那一個。<br><br>你花了比以前更久的時間纏繃帶。膝蓋在陰雨天會提醒你，它記得所有你想忘記的${role.strain}。<br><br>比賽在下午三點開打。觀眾席上坐著幾位家長、一隻在陰影下打盹的狗，還有一個推著冰棒車、順便看球的老先生。<br><br>依然有幾個熱情球迷，從年輕時就追著你的比賽。你退休了，他們也有時間了，依然常常到場舉著毛巾，唱著你的應援曲。<br><br>${role.first}沒有人歡呼，只有隊友在休息區敲了敲欄桿。<br><br>${role.realize}<br><br>心跳的頻率，和十六歲那年第一次上場，一樣。<br><br>比賽結束後，大家蹲在地上一起收壘包、拔起邊線的木樁。你把整理好的球具搬上車，動作熟練得像做過一千次。<br><br>有個孩子跑過來，有點害羞地問你：「前輩，你為什麼還要打？」<br><br>你想了很久。<br><br>想到那些傷、那些被下放的季節、那些在二軍球場等待電話的夜晚。想到最後一場職業賽，你在休息區把帽子壓得很低，怕被拍到。<br><br>然後你把袋子的拉鍊拉上，說：<br><br>「因為明天還有下一場。」<br><br>天暗下來了。已經不是職業了，球場只剩下一盞燈。<br><br>你回頭看了一眼。<br><br>紅土被今天的雨打得有點坑漥，明天早上得先整理一下。<br><br>——你的球員生涯結束了。<br><br>你的棒球，還沒有。`};
}
export const POST_CAREER_ENDINGS={
  ...
  otherAngle:{title:'另一個角度',body:`走進球場時，你還是逕直走向休息室，只是你身上穿的已經不是球衣了。<br><br>守衛看你一眼，什麼也沒問就讓你過去。你的證件掛在胸前，上面寫著「媒體」。<br><br>下午四點，打擊練習。<br><br>你站在護網後面，跟以前一樣看著球飛。差別只在於，現在你手上拿的是筆記本，穿的是西裝。<br><br>「前輩！」有人在你背後喊。是那個去年才升上一軍的內野手。<br><br>「手怎麼樣？」<br><br>「還好啦，就有點腫。」他把手舉起來給你看，指節有點變形。「教練說今天先讓我打 DH。」<br><br>你點點頭，在本子上寫了一行字。這是球評的工作——不是為了講出來，是為了知道「什麼時候不要講」。<br><br>你又晃去牛棚，跟投手教練閒聊三分鐘。你問今天誰不能用，他說了兩個名字，然後補一句：「別講喔。」<br><br>「我知道。」你說。你當然知道。你以前也是那個「別講喔」的人。<br><br>下午六點四十，播報室。<br><br>主播已經坐好了，看到你笑：「今天有料嗎？」<br><br>「有一點。但都不能講。」<br><br>主播笑了，他知道這句話的意思，他也不深問。<br><br>比賽開始。<br><br>一局上，第一棒打了一顆看似平凡的右外野飛球。<br><br>主播：「這只是個平凡的飛球，平凡的飛球，哇，出大牆！」<br><br>你：「這球仰角有點略高，但是球場裡面有風，把球的距離帶遠了。」<br><br>五局，滿壘。<br><br>主播：「這球呢？這球呢？」<br><br>你：「感覺很有機會，只是很可惜，有點切到棒頭了。」<br><br>你看著主播聲嘶力竭，而你只是從播報室看著那個你很熟悉的球場，只是用一個很不熟悉的角度。<br><br>七局，那個手指腫起來的內野手站上打擊區。<br><br>主播：「他今天打 DH，狀況看起來還不錯耶。」<br><br>你頓了半秒。<br><br>「嗯，不錯。」<br><br>球數兩好三壞，他咬中一顆外角速球，打向右外野，落地形成二壘安打。整個休息區跳起來。<br><br>主播：「這球！這球！漂亮！」<br><br>你在麥克風前笑了一下，說：「這球打得很好。」<br><br>你沒說的是：他今天連握棒都會痛，這支安打是他忍著打的。<br><br>有些事情不用說出來，才是對場上那個人最好的尊重。<br><br>九局結束。<br><br>你收好耳機，走出播報室，下樓的時候剛好遇到那個內野手，手上冰敷袋纏得像個粽子。<br><br>「前輩，我今天那支——」<br><br>「我知道。」你說，「打得很好。」<br><br>他愣了一下，然後笑得像個大學生。<br><br>隔天，有球迷剪了一段主播的播報精華，而後面有你那冷靜的評論，配字：<br><br>「這只是個平凡的飛球。」<br><br>底下最高愛心的留言寫著：<br><br>「主播講平凡，不一定平凡，但這個球評的每一句話，都像是預言家。」<br><br>——你不在場上了。<br>但你知道每一顆球，究竟平不平凡。`}
};
...
export function endGame(reason){
  ...
  if(S.intlCount>0){ const IS=S.intlStat;
    const il=S.intlLog||[];
    if(S.pos==='P'){
      const rows=il.map(r=>{ const st=r.st, era=RP_F2(baseballERA(st)); return `<tr><td>${settlementYearHTML(r.year)}</td><td style="text-align:left;white-space:nowrap">${r.name}</td><td>${r.rank}</td><td>${st.G}</td><td>${fmtIP(st.IP)}</td><td>${st.W}</td><td>${st.SV}</td><td>${st.SO}</td><td>${era}</td></tr>`; }).join('');
