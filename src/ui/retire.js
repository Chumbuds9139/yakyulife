import {S, blankStat, bucketOf, CAREER_STAT_BUCKETS, CAREER_EVAL_BUCKETS} from '../core/state.js?v=1.6.2';
import {R, ri, SEED} from '../core/rng.js?v=1.6.2';
import {OFFICIAL_URL} from '../config.js?v=1.6.2';
import {LV, LG_N, CPBL_TEAMS, NPB_TEAMS, MLB_TEAMS, INDEP_TEAMS, CORPORATE_TEAMS, teamNick, npbStadium} from '../data/teams.js?v=1.6.2';
...
import {roleN, fmtIP, slgOf, baseballERA, baseballWHIP, pitG, pitBB} from '../engine/season.js?v=1.6.2';
import {fmtMoney} from '../engine/contract.js?v=1.6.2';
import {isChampionshipYear, isProChampionshipYear} from '../engine/championship.js?v=1.6.2';
import {capTeam, careerMilestones, honorGroups, honorSections, posLegendPhrase, primaryPos, statTable, statTables, tierOf, yearRanges, honorText,
  twoWayView, twHasPit, twHasBat} from '../engine/career.js?v=1.6.2';
import {shareImageSheet} from './share-image.js?v=1.6.2';
/* ================= 結算圖資料建構 =================
