import {S, blankStat, bucketOf, CAREER_STAT_BUCKETS, CAREER_EVAL_BUCKETS} from '../core/state.js?v=1.5.23';
import {R, ri, SEED} from '../core/rng.js?v=1.5.23';
import {OFFICIAL_URL} from '../config.js?v=1.5.23';
import {LV, LG_N, CPBL_TEAMS, NPB_TEAMS, MLB_TEAMS, INDEP_TEAMS, CORPORATE_TEAMS, teamNick, npbStadium} from '../data/teams.js?v=1.5.23';
import {TIER_TH, FAN, RP_LV_SUF} from '../data/economy.js?v=1.5.23';
import {TRAIT_KEYS} from '../data/traits.js?v=1.5.23';
import {$, card, choose, divider, board, actClear} from './dom.js?v=1.5.23';
import {careerTimelineCard, tlNote} from './timeline.js?v=1.5.23';
import {traitNames, traitTagStyle, traitColorRank} from './traits.js?v=1.5.23';
import {roleN, fmtIP, slgOf, baseballERA, baseballWHIP} from '../engine/season.js?v=1.5.23';
import {fmtMoney} from '../engine/contract.js?v=1.5.23';
import {isChampionshipYear, isProChampionshipYear} from '../engine/championship.js?v=1.5.23';
import {capTeam, careerMilestones, honorGroups, posLegendPhrase, primaryPos, statTable, tierOf, yearRanges, honorText} from '../engine/career.js?v=1.5.23';
import {shareImageSheet} from './share-image.js?v=1.5.23';
/* ================= 結算圖資料建構 =================
