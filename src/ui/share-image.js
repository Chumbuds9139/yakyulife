...
import {APP_VER, OFFICIAL_HOST} from '../config.js?v=1.6.4';
import {TEAM_COLOR, LG_N} from '../data/teams.js?v=1.6.4';
import {RP_TICKS} from '../data/economy.js?v=1.6.4';
import {TRAIT_KEYS} from '../data/traits.js?v=1.6.4';
import {$, teamChip, modalOpen, modalClose} from './dom.js?v=1.6.4';
import {THEME_NAMES} from './prefs.js?v=1.6.4';
import {traitNames, traitColorRank} from './traits.js?v=1.6.4';
import {fmtMoney} from '../engine/contract.js?v=1.6.4';
import {twoWayView} from '../engine/career.js?v=1.6.4';
import {rpTagline, rpFamily, RP_F3, RP_F2, rpCumData, rpIntlData, rpHonorItems, rpOrgOf, rpProData, rpSalaryData, championshipYear} from './retire.js?v=1.6.4';
