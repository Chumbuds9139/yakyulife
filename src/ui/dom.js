...
import {APP_VER, SPONSOR_URL} from '../config.js?v=1.6.2';
import {renderTraits, traitName} from './traits.js?v=1.6.2';
...
import {playerName, stageLabel} from '../core/state.js?v=1.6.2';
import {salParts, fmtMoney} from '../engine/contract.js?v=1.6.2';
import {roleN, fmtIP, slgOf, baseballERA} from '../engine/season.js?v=1.6.2';
import {honorGroups, yearRanges} from '../engine/career.js?v=1.6.2';
