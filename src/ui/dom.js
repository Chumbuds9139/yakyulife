...
import {APP_VER, SPONSOR_URL} from '../config.js?v=1.5.7';
import {renderTraits, traitName} from './traits.js?v=1.5.7';
import {clearAlloc, allocFullClose} from './alloc.js?v=1.5.7';
import {themeModal, applyBigText, applyMobileUI} from './prefs.js?v=1.5.7';
import {DPN, POSN} from '../data/abilities.js?v=1.5.7';
import {TEAM_COLOR, LV} from '../data/teams.js?v=1.5.7';
import {TRAIT_KEYS, TRAIT_FX} from '../data/traits.js?v=1.5.7';
import {playerName, stageLabel} from '../core/state.js?v=1.5.7';
