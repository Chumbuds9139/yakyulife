...
export const TRAIT_N={genius:'天才',iron:'鐵人',glass:'玻璃人',scum:'渣男',late:'大器晚成',oldghost:'老鬼',adking:'業配王',miraclegen:'奇蹟世代',strongpitch:'強投少年',stronghit:'強打少年',championmaker:'優勝請負人',disc:'自律狂',academy:'學院派',intlace:'國際賽之鬼',franchise:'神主牌',clutch:'大心臟',favorite:'愛將',phoenix:'浴火重生',onetool:'只會這個',rubber:'橡膠手臂',goldcloth:'黃金聖衣',confidante:'閨中密友',smallschool:'小學校之光',grinder:'努力仔',yips:'失憶症',distract:'外務纏身',cancer:'更衣室毒瘤',ambience:'氣氛大師',thief:'薪水小倫',latepractice:'練球遲到',combo:'大巧不工',taiwan:'Team Taiwan',pitcherTC:'投手三冠王',hitterTC:'打擊三冠王'};
