...
export const TRAIT_KEYS={pos:['legend','samurai','goldcloth','mrteam','confidante','genius','iron','late','oldghost','adking','miraclegen','strongpitch','stronghit','championmaker','disc','academy','intlace','franchise','clutch','favorite','phoenix','rubber','onetool','smallschool','grinder','combo','rainbow','pitcherTC','hitterTC'],
