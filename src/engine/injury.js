...
import {R, ri, pick, chance, clamp} from '../core/rng.js?v=1.6.1';
...
import {addAb} from './ability.js?v=1.6.1';
import {isSP, pitG, TW_EFFORT} from './season.js?v=1.6.1';
import {removeTrait} from '../flow/events.js?v=1.6.1';
