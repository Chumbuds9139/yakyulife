...
import {ABL, POS_AB, PITCH_TOOLS, DPN, DP_TH, DP_BAR, POS_ADJ_RUNS, DP_RANK} from '../data/abilities.js?v=1.6.2';
import {LV} from '../data/teams.js?v=1.6.2';
import {card, choose, board} from '../ui/dom.js?v=1.6.2';
import {roleN, pitcherRole, bullpenRole} from './season.js?v=1.6.2';
...
export function abStepCost(k,cur){
  return isPitchTool(k)?(cur>=66?7:cur>=58?4:cur>=50?2:1)
                       :(cur>=72?3:cur>=64?2:1);
}
