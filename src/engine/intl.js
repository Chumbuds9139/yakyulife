...
import {isSP, fmtIP, outsFromIP, ipFromOuts, normalizeIP, baseballERA} from './season.js?v=1.5.2-r1';
import {ovr} from './ability.js?v=1.5.2-r1';
import {intlFinishIndex} from './championship.js?v=1.5.2-r1';
import {checkChampionTrait} from '../flow/events.js?v=1.5.2-r1';
