...
import {isSP, fmtIP, outsFromIP, ipFromOuts, normalizeIP, baseballERA} from './season.js?v=1.5.19';
import {ovr} from './ability.js?v=1.5.19';
import {intlFinishIndex} from './championship.js?v=1.5.19';
import {checkChampionTrait} from '../flow/events.js?v=1.5.19';
import {intlInviteCopy, intlEventName} from '../data/intl-copy.js?v=1.5.19';
