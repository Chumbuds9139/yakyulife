...
import {isSP, fmtIP, outsFromIP, ipFromOuts, normalizeIP, baseballERA} from './season.js?v=1.5.1-r2';
import {ovr} from './ability.js?v=1.5.1-r2';
import {intlFinishIndex} from './championship.js?v=1.5.1-r2';
import {checkChampionTrait} from '../flow/events.js?v=1.5.1-r2';
