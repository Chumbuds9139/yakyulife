...
import {ri, pick, chance} from '../core/rng.js?v=1.6.4';
import {NPB_TEAMS, CORPORATE_TEAMS, INDEP_TEAMS} from '../data/teams.js?v=1.6.4';
import {card, choose, board, menuModal} from '../ui/dom.js?v=1.6.4';
import {tlNote} from '../ui/timeline.js?v=1.6.4';
import {ovr, playerType} from './ability.js?v=1.6.4';
import {primaryPos} from './career.js?v=1.6.4';
import {fmtMoney, flushSalaryFloor, makeOffers, pickOfferUI, signTo, makeContract, rollCpblImport, cpblEntryFlavor, returnHomeSign} from './contract.js?v=1.6.4';
