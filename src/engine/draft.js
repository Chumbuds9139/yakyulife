...
import {ri, pick, chance} from '../core/rng.js?v=1.5.26';
import {NPB_TEAMS, CORPORATE_TEAMS, INDEP_TEAMS} from '../data/teams.js?v=1.5.26';
import {card, choose, board, menuModal} from '../ui/dom.js?v=1.5.26';
import {tlNote} from '../ui/timeline.js?v=1.5.26';
import {ovr, playerType} from './ability.js?v=1.5.26';
import {primaryPos} from './career.js?v=1.5.26';
import {fmtMoney, makeOffers, pickOfferUI, signTo, makeContract, rollCpblImport} from './contract.js?v=1.5.26';
import {startYear} from '../flow/phases.js?v=1.5.26';
