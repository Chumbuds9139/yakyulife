...
import {ri, pick} from '../core/rng.js?v=1.6.2';
import {CPBL_TEAMS} from '../data/teams.js?v=1.6.2';
...
import {fmtMoney, makeOffers, pickOfferUI, signTo} from './contract.js?v=1.6.2';
