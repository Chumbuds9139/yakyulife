...
import {ri, pick} from '../core/rng.js?v=1.6.0';
import {CPBL_TEAMS} from '../data/teams.js?v=1.6.0';
...
import {fmtMoney, makeOffers, pickOfferUI, signTo} from './contract.js?v=1.6.0';
