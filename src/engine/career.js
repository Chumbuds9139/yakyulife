...
import {clamp} from '../core/rng.js?v=1.5.28';
import {DPN, POSN, POS_ADJ_RUNS, POS_TIER_K, POS_TIER_STR} from '../data/abilities.js?v=1.5.28';
import {LG_N} from '../data/teams.js?v=1.5.28';
import {TIER_TH, LEAGUE_K, MILESTONE_DEF, HOF_TH_K} from '../data/economy.js?v=1.5.28';
import {fmtIP, slgOf, roleName3, baseballERA, baseballWHIP} from './season.js?v=1.5.28';
