...
import {DPN, POSN, POS_ADJ_RUNS} from '../data/abilities.js?v=1.5.1-r4';
import {LG_N} from '../data/teams.js?v=1.5.1-r4';
import {TIER_TH, MILESTONE_DEF} from '../data/economy.js?v=1.5.1-r4';
import {fmtIP, slgOf, roleName3, baseballERA, baseballWHIP} from './season.js?v=1.5.1-r4';
/* ================= 生涯終章 ================= */
