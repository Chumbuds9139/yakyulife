...
import {clamp} from '../core/rng.js?v=1.5.3-r3';
import {DPN, POSN, POS_ADJ_RUNS} from '../data/abilities.js?v=1.5.3-r3';
import {LG_N} from '../data/teams.js?v=1.5.3-r3';
import {TIER_TH, LEAGUE_K, MILESTONE_DEF} from '../data/economy.js?v=1.5.3-r3';
import {fmtIP, slgOf, roleName3, baseballERA, baseballWHIP} from './season.js?v=1.5.3-r3';
/* ================= 生涯終章 ================= */
