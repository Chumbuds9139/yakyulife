...
import {chance, clamp} from '../core/rng.js?v=1.5.2';
import {DPN, GLOVE_TH} from '../data/abilities.js?v=1.5.2';
import {LV} from '../data/teams.js?v=1.5.2';
import {card} from '../ui/dom.js?v=1.5.2';
import {tlNote} from '../ui/timeline.js?v=1.5.2';
import {isSP, slgOf, baseballERA} from './season.js?v=1.5.2';
