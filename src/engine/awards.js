...
import {chance, clamp} from '../core/rng.js?v=1.6.1';
import {DPN, GLOVE_TH, GLOVE_K} from '../data/abilities.js?v=1.6.1';
import {LV} from '../data/teams.js?v=1.6.1';
import {card} from '../ui/dom.js?v=1.6.1';
import {tlNote} from '../ui/timeline.js?v=1.6.1';
import {isSP, slgOf, baseballERA, pitG} from './season.js?v=1.6.1';
import {isCareerScoringAward, splitBySide} from './award-rules.js?v=1.6.1';
