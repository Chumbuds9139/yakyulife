import {S, blankStat, bucketOf, nextStep, stageLabel} from '../core/state.js?v=1.5.20';
import {R, ri, chance, clamp, N0} from '../core/rng.js?v=1.5.20';
import {POS_ADJ_RUNS, POS_PT_BAR} from '../data/abilities.js?v=1.5.20';
import {LV, HS_CUPS, U_CUPS, spLoad} from '../data/teams.js?v=1.5.20';
import {card, board} from '../ui/dom.js?v=1.5.20';
import {ovr, careerAllStars, toolGap} from './ability.js?v=1.5.20';
import {tjAccrue, tjGamble} from './injury.js?v=1.5.20';
/* temporary scaffold until awards/intl/contract/flow are extracted */
import {demotionAudit} from './contract.js?v=1.5.20';
import {awards} from './awards.js?v=1.5.20';
import {maybeIntl} from './intl.js?v=1.5.20';
