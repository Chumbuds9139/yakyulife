...
import {R, ri, pick, chance, clamp, SEED} from '../core/rng.js?v=1.5.27';
import {LV, PATHS, CPBL_TEAMS, NPB_TEAMS, MLB_TEAMS, CORPORATE_TEAMS, INDEP_TEAMS, isAmateurClub} from '../data/teams.js?v=1.5.27';
import {AMA_ANNUAL, LEVEL_MIN_ANNUAL, MLB_SERVICE_MINOR_MIN} from '../data/economy.js?v=1.5.27';
import {card, choose, board} from '../ui/dom.js?v=1.5.27';
import {tlNote} from '../ui/timeline.js?v=1.5.27';
import {ovr} from './ability.js?v=1.5.27';
import {injuryMarketStatus} from './injury.js?v=1.5.27';
import {hasActiveFranchise} from './tenure.js?v=1.5.27';
import {seasonSalaryRating, currentSalaryRating} from './season.js?v=1.5.27';
import {capTeam} from './career.js?v=1.5.27';
import {traitCard, removeTrait} from '../flow/events.js?v=1.5.27';
import {advance} from './draft.js?v=1.5.27';
import {finishContractYear} from '../flow/phases.js?v=1.5.27';
import {endGame} from '../ui/retire.js?v=1.5.27';
...
/* ---------- 旅外回歸：母隊優先 ---------- */
/* 「母隊」＝離開該聯盟前效力的最後一隊，不是待最久的隊。回得去不代表回得成——
   合約金額與角色定位談不攏在現實裡本來就常見，所以只有 90% 談成，另外 10% 會輾轉加盟同聯盟的其他球隊。
