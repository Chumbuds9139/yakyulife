  ...
  if(S.org==='MiLB'&&o>=LV.NPB1.min){
    faOpts.push({t:'轉戰日職一軍',s:'把天賦帶回亞洲職棒的最高殿堂',
      f:()=>{ returnHomeSign('MiLB','NPB','NPB1',
        `雖然大聯盟的合約書就攤在桌上，但在幾個輾轉難眠的夜裡，你還是把筆放了下來。橫越太平洋的十幾個小時、一年有兩百天在陌生的旅館醒來——走到這個年紀，你想的已經不是舞台能站多高，而是離家近一點：三個多小時的航程，家人想看球，隔天就能坐在內野。長考之後，你決定把天賦帶回亞洲職棒的最高殿堂：<b class="hl">日本職棒</b>。`);
        advance(); }});
  }
