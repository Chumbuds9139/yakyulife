...
import {R, pick, chance, clamp} from '../core/rng.js?v=1.5.0-r4';
import {ABL, POS_AB} from '../data/abilities.js?v=1.5.0-r4';
import {LV} from '../data/teams.js?v=1.5.0-r4';
import {EVENTS, EVENT_CATEGORY_NAMES, EVENT_COMBINATIONS} from '../data/events.js?v=1.5.0-r4';
import {card, choose, board} from '../ui/dom.js?v=1.5.0-r4';
import {addAb, statBonus, ovr} from '../engine/ability.js?v=1.5.0-r4';
import {majorChampionshipCount} from '../engine/championship.js?v=1.5.0-r4';
