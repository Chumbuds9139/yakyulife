...
import {R, pick, chance, clamp} from '../core/rng.js?v=1.5.23';
import {ABL, POS_AB} from '../data/abilities.js?v=1.5.23';
import {LV} from '../data/teams.js?v=1.5.23';
import {EVENTS, EVENT_CATEGORY_NAMES, EVENT_COMBINATIONS, EVENT_ROUTES, eventInjuryRisk} from '../data/events.js?v=1.5.23';
import {card, choose, board} from '../ui/dom.js?v=1.5.23';
import {addAb, statBonus, statBonusTxt, abGainTxt, ovr} from '../engine/ability.js?v=1.5.23';
import {majorChampionshipCount} from '../engine/championship.js?v=1.5.23';
