import {S, stepQ, nextStep, stageLabel, levelName} from '../core/state.js?v=1.6.2';
...
import {addAb, ovr, ovrPit, ovrBat, dposReview, statBonusTxt, enforcePerfectAbilities} from '../engine/ability.js?v=1.6.2';
import {rollInjury, tjCap, tjEffortMult} from '../engine/injury.js?v=1.6.2';
import {isMrTeamEligible, accrueCpbl1Service} from '../engine/tenure.js?v=1.6.2';
